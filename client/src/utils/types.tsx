...
export const bigintToHex = (v: BigNumberish | null): string => (!v ? '0x0' : `0x${BigInt(v).toString(16)}`)
...
export const entityIdToKey = (component: Component, keyName: string, entityId: Entity) => (BigInt(getComponentValue(component, entityId)?.[keyName] ?? 0))
